            ...
            <div>
                <div className="fontsTabToolbar">
                    <ButtonToolbar bsSize="small">
                        ...
                        <ButtonGroup>
                            <Button onClick={(e) => { /*FontsTab.clear();*/ FontsTab.blurButton(e);}} title="Clear font list." disabled><Glyphicon glyph="trash" /></Button>
                        </ButtonGroup>
                    </ButtonToolbar>
                </div>
                <div className="fontsTabContent">
                    <ListGroup>
                        {this.state.items.map((item) => {
                                let display = `${item.displayName}, ${item.displayStyle} ${item.displaySize}`;
                                let style = {
                                    whiteSpace:"nowrap",
